...
\section{Summary}
Computer Engineering student at Purdue University with experience in systems programming, web development, and open-source collaboration. Built projects in C, Ruby on Rails, and Python, including a Game Boy emulator and event management platform. Interested in semiconductors, embedded systems, and developer tooling.
...
\begin{tabularx}{\linewidth}{@{}l X@{}}
    \textbf{Programming Languages} & Python, Java, C, Ruby, Lua, HTML/CSS, JavaScript, \& \LaTeX \\
...
\begin{jobshort}{Internship at Sledgehammer Infosystems}{June 2023 - August 2023}
    \begin{itemize}
        \item Contributed to Ruby on Rails web application development using MVC architecture
        \item Collaborated in open-source development workflows using Git and issue tracking
...
\begin{jobshort}{Game Boy Emulator \( \vert \) C}{\href{https://github.com/IEEE-C-Society-25-26/Game-Boy-Project}{https://github.com/IEEE-C-Society-25-26/Game-Boy-Project}}
    \begin{itemize}
        \item Implemented CPU instruction handling and register logic for a Game Boy emulator written in C
        \item Refactored subsystem interfaces to improve code maintainability
        \item Authored technical documentation for emulator architecture and debugging workflows
    \end{itemize}
\end{jobshort}

\begin{jobshort}{Gatherpack \( \vert \) Ruby on Rails}{\href{https://gatherpack.com}{https://gatherpack.com}}
    \begin{itemize}
        \item Developer of a people and event organization web app
        \item Designed event scheduling subsystem supporting recurring events and calendar synchronization
        \item Designed responsive UI components optimized for mobile devices
        \item Developed scheduling and calendar subsystems for event coordination
    \end{itemize}
\end{jobshort}
...
\begin{jobshort}{GreatStudier \( \vert \) Python}{\href{https://github.com/greatericontop/GreatStudier}{https://github.com/greatericontop/GreatStudier}}
    \begin{itemize}
        ...
        \item Maintained and developed functionality for web scraping the contents for a study sets off of Quizlet
...
\begin{jobshort}{Translator For Open Source Projects}{\href{https://hosted.weblate.org/user/Gerseneck/}{https://hosted.weblate.org/user/Gerseneck/}}
    \begin{itemize}
        \item Contributed Simplified Chinese translations for System76 COSMIC DE, Fotema, Gaphor, Suroi, and other projects
